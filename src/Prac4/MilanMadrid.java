...
public class MilanMadrid extends JFrame {
    ...
    private MilanMadrid() {
        ...
        btn1.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                MScore++;
                label1.setText("Result: " + MScore + " X " + RMScore);
                label2.setText("Last Scorer: AC Milan");
                label3.setText("Winner: " + getWinner(MScore, RMScore));
            }
    ...
    private String getWinner(int MScore, int RMScore) {
        if (MScore > RMScore) return "AC Milan";
        if (MScore < RMScore) return "Real Madrid";
        return "Ничья";
    }
